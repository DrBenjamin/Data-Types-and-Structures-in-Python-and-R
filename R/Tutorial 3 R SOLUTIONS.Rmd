...
## str_subset() solution
str_subset(words, pattern = "[aeiou]", negate = TRUE)
```
...
rincome_f <- rincome %>%
  ...
  fct_collapse(
    ...
    `$10000 or more` = c("$25000 or more", str_c(
      "$", c("10000", "15000", "20000"),
...
```{r BB-bday}
birthday <- mdy("July 2 2024", tz = "Europe/London")
