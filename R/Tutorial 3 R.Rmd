...
```{r task7}
## your answer here 
gss_cat_income <- gss_cat['rincome']
typeof(gss_cat_income)
gss_cat_income2 <- gss_cat[['rincome']]
typeof(gss_cat_income2)

gss_cat_income_cat <- as_factor(gss_cat_income2)
levels(gss_cat_income_cat)
```
