...
You can use `str_view()` to view the HTML rendering of a regular expression match. This shows the first match. The view all matches, you can use `str_view_all()`
